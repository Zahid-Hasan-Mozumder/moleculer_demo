        ...
        getAll: {
            async handler() {
                ...
                try {
                    ...
                    var requestBody = { "q": "SELECT COUNT(*) FROM item" };
                    ...
                    for (var i = 1; i <= iteration; i++) {
                        ...
                        const requestBody = { "q": `SELECT * FROM (SELECT ROWNUM AS RN, * FROM (SELECT * FROM item ORDER BY id)) WHERE (rn BETWEEN ${start} AND ${end}) ORDER BY rn` };
